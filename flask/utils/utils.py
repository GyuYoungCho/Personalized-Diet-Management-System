...
def kmean_anchors(path='./data/custom/valid.txt', n=9, img_size=(640, 640), thr=0.20, gen=1000):
...
def fitness(x):
    ...
    w = [0.0, 0.0, 0.9, 0.1]  # weights for [P, R, mAP, F1]@0.5 or [P, R, mAP@0.5, mAP@0.5:0.95]
    return (x[:, :4] * w).sum(1)
...
def plot_one_box(x, img, color=None, label=None, line_thickness=None):
    ...
    if label:
        ...
        cv2.putText(img, "", (c1[0], c1[1] - 2), 0, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
